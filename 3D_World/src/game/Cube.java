...
public class Cube {
	...
	private void drawGround(GL2 gl) {
		...
		//Front face
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(ftl.getX(),ftl.getY(),ftl.getZ());
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(ftr.getX(),ftr.getY(),ftr.getZ()); 
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(fbr.getX(),fbr.getY(),fbr.getZ()); 
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(fbl.getX(),fbl.getY(),fbl.getZ());  
		
		//Right Face
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(ftr.getX(),ftr.getY(),ftr.getZ());
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(btr.getX(),btr.getY(),btr.getZ()); 
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(bbr.getX(),bbr.getY(),bbr.getZ()); 
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(fbr.getX(),fbr.getY(),fbr.getZ());
		
		//Back face
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(btr.getX(),btr.getY(),btr.getZ());
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(btl.getX(),btl.getY(),btl.getZ()); 
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(bbl.getX(),bbl.getY(),bbl.getZ()); 
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(bbr.getX(),bbr.getY(),bbr.getZ());

		//Left face
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(btl.getX(),btl.getY(),btl.getZ());
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(ftl.getX(),ftl.getY(),ftl.getZ()); 
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(fbl.getX(),fbl.getY(),fbl.getZ()); 
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(bbl.getX(),bbl.getY(),bbl.getZ());
		
		//Top face
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(ftl.getX(),ftl.getY(),ftl.getZ());
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(ftr.getX(),ftr.getY(),ftr.getZ()); 
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(btr.getX(),btr.getY(),btr.getZ()); 
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(btl.getX(),btl.getY(),btl.getZ());
		
		//Bottom face
		gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f(fbl.getX(),fbl.getY(),fbl.getZ());
		gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(fbr.getX(),fbr.getY(),fbr.getZ()); 
		gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(bbr.getX(),bbr.getY(),bbr.getZ()); 
		gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(bbl.getX(),bbl.getY(),bbl.getZ());
	...
	public boolean isPointInside(float x, float y, float z) {
		return  Math.abs(x - center.getX()) < SIZE / 2 && 
				Math.abs(y - center.getY()) < SIZE / 2 && 
